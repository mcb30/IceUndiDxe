...
#-------------------------------------------------------------------------------
# Use DebugPrint() function across the code for Serial Port debug prints.
# Default settings: Baud: 115200, Data: 8 bit, Stop bit: 1, Parity: None
#-------------------------------------------------------------------------------
...
[Components]
  IntelUndiPkg/IceUndiDxe/IceUndiDxe.inf
